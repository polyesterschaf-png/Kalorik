...
# Schülermodus
    ...
    # Stationstitel robust in Dateikomponenten umwandeln
    ...
    # ---------------------------------------------------------
        ...
        df = st.data_editor(df, num_rows="dynamic", use_container_width=True, key="editor_ac")
        ...
        if st.button("💾 Ergebnisse speichern", key="save_ac"):
            if not gruppen_id:
            ...
            try:
                ...
                st.error(f"GitHub-Fehler beim Speichern: {e}")
                st.stop()
            else:
    ...
    # ---------------------------------------------------------
        ...
        df = st.data_editor(df, num_rows="dynamic", use_container_width=True, key="editor_e")
        ...
        if st.button("💾 Ergebnisse speichern", key="save_e"):
            if not gruppen_id:
                st.error("Bitte zuerst eine Gruppen-ID eingeben.")
                st.stop()
            try:
    ...
    # ---------------------------------------------------------
        ...
        if st.button("💾 Ergebnisse speichern", key="save_d"):
            if not gruppen_id:
                st.error("Bitte zuerst eine Gruppen-ID eingeben.")
                st.stop()
            try:
